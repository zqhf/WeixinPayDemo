...
public class Configure {  
     ...
     *  
     */  
    private static String appID = "wxab8acb865bb1637e";  
  
    /** 
     * 微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到） 
     *  
     */  
    private static String mchID = "11473623";  
     ...
     *  
     */  
    public static String batchQueryComment = "https://api.mch.weixin.qq.com/billcommentsp/batchquerycomment";
    /** 
     * 转换短链接 
     */  
    ...
    public static String UnifiedOrder_API = "https://api.mch.weixin.qq.com/sandboxnew/pay/unifiedorder";//沙箱环境
    /** 
     * 关闭订单 
     */  
